...
matches_clusters as (
    ...
    from matches_wta as m
      left join wta_tournaments as t on m.tournament_id = t.tournament_id
      left join wta_players_clusters as c1 on m.p1_name = c1.player_name
      left join wta_players_clusters as c2 on m.p2_name = c2.player_name
),
