...
final as (
  ...
  where
    (p1_model_p - p1_pinnacle_odds_p >= 0.027
    and p1_model_odds < 2.3)
    or (p2_model_p - p2_pinnacle_odds_p >= 0.027
    and p2_model_odds < 2.3)
    and c1.matches_past_year > 5
    and c2.matches_past_year > 5
)
