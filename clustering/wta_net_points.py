...
data = utils.get_net_points_clustering_data('wta')
...
centroid_df = pd.DataFrame(sorted_centroids,
                          ...
                          index=pd.Index([1, 2, 3], name='cluster'))
...
# Upload to BigQuery
utils.load_clusters_to_bq(client, final_df, 'tennis-358702.raw_layer.wta_net_points_clusters')